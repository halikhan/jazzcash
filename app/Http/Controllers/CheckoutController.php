...
class CheckoutController extends Controller
{
	...
	public function DoCheckout(Request $request)
	{
		...
		$post_data =  array(
			...
			"pp_Language" 			=> Config::get('constants.jazzcash.LANGUAGE'),
			"pp_MerchantID" 		=> "MC46380",
			"pp_SubMerchantID" 		=> "",
			"pp_Password" 			=> "vtx82y2zy0",
			"pp_BankID" 			=> "TBANK",
			"pp_ProductID" 			=> "RETL",
        ...
        // dd($post_data = Session::get('post_data'));
		echo '<pre>';
		print_r($post_data);
		echo '</pre>';
	...
	private function get_SecureHash($data_array)
	{
		...
		$str = "0x8uuwsetz".$str;
		$pp_SecureHash = hash_hmac('sha256', $str, "0x8uuwsetz");
	...
	public function paymentStatus(Request $request)
	{
		...
		if($response['pp_ResponseCode'] == '199')
		{
