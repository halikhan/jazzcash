        ...
        @foreach ($products as $product)
          <div class="col-lg-3 col-md-3 mb-3">
                <div class="card">
                    ...
                    <img src="{{ asset('storage/jazzCash/' . $product->image) }}" alt="image"  >
                    @else
                        <img src="{{ (!empty($product->image))?
                            asset('storage/jazzCash/'.$product->image):asset('storage/No-image.jpg') }}"
                            >
                    @endif
                        {{-- <img src="{{ asset('storage/jazzCash/'.$product->image) }}" class="card-img-top"></a> --}}
                    <div class="card-body">
        ...
        <div class="jsformWrapper">
            <form name="jsform" method="post" action="https://sandbox.jazzcash.com.pk/CustomerPortal/transactionmanagement/merchantform/">
                ...
                <div class="formFielWrapper">
                    ...
                    <input type="text" name="pp_MerchantID" value="MC46380">
                </div>
                ...
                <div class="formFielWrapper">
                    ...
                    <input type="text" name="pp_Password" value="vtx82y2zy0">
                </div>

                <div class="formFielWrapper">
                    <label class="active">pp_TxnRefNo: </label>
                    <input type="text" name="pp_TxnRefNo" id="pp_TxnRefNo" value="T20220803035820">
                </div>
                ...
                <div class="formFielWrapper">
                    ...
                    <input type="text" name="pp_TxnDateTime" id="pp_TxnDateTime" value="20220803035820">
                </div>

                <div class="formFielWrapper">
                    <label class="active">pp_TxnExpiryDateTime: </label>
                    <input type="text" name="pp_TxnExpiryDateTime" id="pp_TxnExpiryDateTime" value="20220804035820">
                </div>
                ...
                <div class="formFielWrapper">
                    ...
                    <input type="text" name="pp_ReturnURL" value="http://127.0.0.1:8000/paymentStatus">
                </div>
                ...
                <input type="hidden" name="salt" value="0x8uuwsetz">
                <br><br>
